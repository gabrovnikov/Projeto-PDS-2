...
class historico{
    ...
    void historico::historico_do_usuario (int num_viagens_queveiodousuario_print){//, int nota_hist, int num_viag){
        
    int num_ruas=31;   int sorteio_lugar, sorteio_nota;    
    cout << "HISTORICO DE " << num_viagens_queveiodousuario_print << " VIAGENS" << endl;
    cout << endl; 
    string vec_strings [31] = {"Rua Jorge Amado","Rua Maracanã","Avenida Mineirão","Avenida Morumbi","Rua João Paulo II",
